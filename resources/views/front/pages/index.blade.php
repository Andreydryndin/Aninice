...
{{--    @include('front.layouts.bottommenu')--}}
@endsection
...
@section('scripts')
    @parent
    <script src="/js/front/searchbar.js" type="text/javascript"></script>
    <script src="https://cdn.jsdelivr.net/gh/xcash/bootstrap-autocomplete@v2.3.5/dist/latest/bootstrap-autocomplete.min.js"></script>
    <script src="/js/front/regions.js" type="text/javascript"></script>
@endsection