...
@section('title', 'Aninice - главная страница')
                ...
                <div class="app-main" id="main">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                                ...
                                <div class="col-md-12">
                                    <form method="POST" action="/admin/parser/get_categories">
                                        <div class="card card-statistics">
                                            ...
                                            <div class="card-body">
                                                <input type="text" class="form-control" placeholder="Url site">
                                            </div>
                                        </div>
                                        <div class="card card-statistics">
                                            <div class="card-header">
                                                <div class="card-heading">
                                                    <h4 class="card-title">Name sites</h4>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                <select name="name_sites" class="form-control">
